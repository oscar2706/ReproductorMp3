...
public class SongsArtistsRVAdapter extends RecyclerView.Adapter<SongsArtistsRVAdapter.SongViewHolder>
    ...
    public class SongViewHolder extends RecyclerView.ViewHolder{
        ...
        public SongViewHolder(View itemView) {
            ...
            songName = (TextView)itemView.findViewById(R.id.nombreArtistaCancion);
        }
    }

    // Le asignamos al adaptador la lista de canciones
    ArrayList<Cancion> canciones;
    public SongsArtistsRVAdapter(ArrayList<Cancion> canciones){
        this.canciones = canciones;
    }

    public SongsArtistsRVAdapter(Context mContext, ArrayList<Cancion> canciones){
        this.canciones = canciones;
    ...
    public void onBindViewHolder(SongViewHolder songViewHolder, int posicion) {
        ...
        songViewHolder.songName.setText(combinacionNA);
